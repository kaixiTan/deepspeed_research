...
def get_args():
    ...
    # add argument so we can directly run difference by using model name in termine
    parser.add_argument("--model_name", type=str, default="gpt_85m", help="Name of the GPT model to train.")
...
def train():
    ...
    config_params = {"config": "deepspeed_config.json"}
    ...
    if args.local_rank == 0:
        ...
        print(f"[RESULT] {round(throughput, 3)}")
